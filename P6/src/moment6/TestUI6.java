...
//		cd = new ColorDisplay(1,5,Color.argb(rand.nextInt(255),rand.nextInt(255),rand.nextInt(255),rand.nextInt(255)),Color.argb(rand.nextInt(255),rand.nextInt(255),rand.nextInt(255),rand.nextInt(255))); // 1 Page (*7) höjd, 5 Page(s) (*7 bredd)
		cd = new ColorDisplay(1,5,Color.argb(rand.nextInt(255),rand.nextInt(255),rand.nextInt(255),rand.nextInt(255)),Color.argb(255,255,255,255)); // 1 Page (*7) höjd, 5 Page(s) (*7 bredd)
